...
class modelcn extends CI_Model {
	...
	public function __construct(){
		...
		$query = $this->db->query("select * from cn_transaction $searchBy order by id_cn desc limit $start, $limit");
		$result = $query->result();
		...
		$query = $this->db->query("select * from cn_transaction $searchBy order by id_cn desc");
